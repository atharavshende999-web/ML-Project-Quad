...
if df is None:
    ...
    st.error(
        "No CSV dataset was found in the application folder."
    )

    st.info(
        "Place your CLV dataset CSV beside app.py and restart the application."
    )
    ...
    if target_column is not None:
        ...
        with c1:
            ...
            st.markdown(
                ...
                <div class="metric-card">
                    ...
                    <div class="metric-description">Customers in dataset</div>
                </div>
                """,
                unsafe_allow_html=True
            )
        ...
        with c2:
            ...
            st.markdown(
                ...
                <div class="metric-card">
                    ...
                    <div class="metric-value">{average_clv:,.2f}</div>
                    <div class="metric-description">Average customer value</div>
                </div>
                """,
                unsafe_allow_html=True
            )
        ...
        with c3:
            ...
            st.markdown(
                ...
                <div class="metric-card">
                    ...
                    <div class="metric-description">Top 25% by CLV</div>
                </div>
                """,
                unsafe_allow_html=True
            )
        ...
        with c4:
            ...
            st.markdown(
                f"""
                <div class="metric-card">
                    <div class="metric-label">MAXIMUM CLV</div>
                    <div class="metric-value">{maximum_clv:,.2f}</div>
                    <div class="metric-description">Highest customer value</div>
                </div>
                """,
                unsafe_allow_html=True
            )
        ...
        with col2:
            ...
            st.markdown(
                ...
                Customers with higher predicted lifetime value
        ...
        st.warning(
            "A CLV target column could not be detected automatically."
        )
...
# ============================================================
    ...
    st.markdown(
        '<div class="section-title">Customer CLV Prediction</div>',
        unsafe_allow_html=True
    )
    ...
    if result is None:
        ...
        st.error(
            "The ML model could not be trained. Check your dataset."
        )

    else:

        st.write(
            "Enter customer information below to estimate Customer Lifetime Value."
        )
        ...
        if st.button(
            ...
            if prediction >= df[target_column].quantile(0.75):

                st.info(
                    "⭐ High-value customer — strong retention priority."
                )

            elif prediction >= df[target_column].median():
...
# ============================================================
    ...
    if len(numerical) >= 2:
        ...
        segment_data = df[numerical].copy()
        ...
        st.success(
            f"{number_of_clusters} customer segments created successfully."
        )
        ...
        st.markdown(
            '<div class="section-title">Segmented Customers</div>',
            unsafe_allow_html=True
        )
        ...
        st.warning(
            "At least two numerical columns are required for segmentation."
        )
...
# ============================================================
    ...
    if result is None:
        ...
        st.markdown(
            ...
            <div class="info-box">
            <b>Purpose</b><br>
            Predict the expected lifetime value of a customer.
            </div>
            """,
            unsafe_allow_html=True
        )
...
# ============================================================
    ...
    st.markdown(
        ...
        Customer Lifetime Value (CLV) Prediction is a machine learning
        application designed to estimate the future value of customers.

        The system analyzes customer-related numerical information,
        trains a Gradient Boosting regression model and generates
        CLV predictions.

        In addition, K-Means clustering is used to divide customers
...
st.caption(
    "Customer Lifetime Value Prediction • Machine Learning Project • Built with Python & Streamlit"
)
